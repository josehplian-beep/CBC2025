            ...
            <CardContent>
              {submitted ? <div className="text-center py-12">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="title" placeholder="e.g., Health, Family, Guidance" value={formData.title} onChange={e => setFormData({
                  ...formData,
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="content" placeholder="Share what you would like us to pray for..." value={formData.content} onChange={e => setFormData({
                  ...formData,
                  content: e.target.value
                })} rows={8} className="resize-none" maxLength={1000} required />
